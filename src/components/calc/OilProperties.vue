...
div(class="lyeWidget hover:shadow-2xl dark:shadow-none border-yellow-800 dark:border-yellow-500")
	...
	ul(class="bg-(--LTheme3) dark:bg-(--Theme3) mt-4 p-2 rounded-lg h-full flex flex-col [&>li>span]:first-of-type:text-black [&>li>span]:first-of-type:dark:text-white [&>li>span]:last-of-type:text-shadow-2xs [&>li>span]:last-of-type:text-yellow-700 [&>li>span]:last-of-type:dark:text-yellow-500")
