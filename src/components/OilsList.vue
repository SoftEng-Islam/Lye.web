...
<template lang="pug">
//- Oils list Section
div(class="lyeWidget p-2 flex flex-col gap-2 min-h-[200px] max-h-[70%] rounded-md overflow-hidden bg-[var(--dark400)]" id="notes")
	div(class="w-full Head bg-purple-500 p-2 rounded-md")
		span(class="text-black font-bold ") All Oils.
	//- Search
	...
	//- Oils
	div(class="OilsList w-full h-[90%] overflow-hidden flex items-start justify-center")
		PerfectScrollbar(class="h-full w-full rounded-lg border-4 border-[var(--dark300)] bg-[var(--dark300)]")
