...
<template lang="pug">
li( class="flex overflow-hidden py-2 first-of-type:border-none border-t border-t-(--LTheme3) dark:border-t-(--Theme3) rounded-md p-2 bg-(--LTheme4) dark:bg-(--Theme4)")
	//- remove Oil
	...
	select(class="h-6 text-sm w-7 outline-none bg-(--LTheme4) dark:bg-(--Theme4) text-gray-300" id="Units")
		option(value="Gram") g
