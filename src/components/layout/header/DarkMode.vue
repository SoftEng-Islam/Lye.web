...
div(class="toggleMode h-8 w-16 ml-3 flex flex-row items-center justify-center rounded-full bg-(--LTheme4) dark:bg-(--Theme4) scale-95" @click="darkModeChecked = !darkModeChecked;")
