...
ul(class="recipe-options")
	...
	li(class="widget md:flex-col bg-(--LTheme4) dark:bg-(--Theme4)" tabindex="2")
		div(class="w-full flex items-center py-2")
			lye-help-icon(:content="'Empty Content'" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
		...
		fieldset(class="w-full flex flex-col items-start gap-2 *:w-full text-black dark:text-white")
			legend(class="mb-4") Select The type of Lye:
			div(class="rounded-md p-2 border border-gray-500 flex flex-row")
				input(class="mr-2" type="checkbox" id="NaOH" name="lyeType" value="NaOH" checked)
				label(for="NaOH") Sodium Hydroxide (NaOH)
				lye-help-icon(:content="naOH" class="ml-auto" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
			div(class="rounded-md p-2 border border-gray-500 flex flex-row")
				input(class="mr-2" type="checkbox" id="KOH" name="lyeType" value="KOH")
				label(for="KOH") Potassium Hydroxide (KOH)
				lye-help-icon(:content="'Here are the weight units used in soap.'" class="ml-auto" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
			div(class="rounded-md p-2 border border-gray-500 flex flex-row")
				input(class="mr-2" type="checkbox" id="KOH70" name="lyeType" value="KOH70")
				label(for="KOH70") KOH 70%
				lye-help-icon(:content="'Here are the weight units used in soap.'" class="ml-auto" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
	...
	li(class="widget md:flex-col bg-(--LTheme4) dark:bg-(--Theme4)" tabindex="3")
		//- Help
		div(class="w-full flex items-center py-2")
			lye-help-icon(:content="'Here are the weight units used in soap.'" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
	...
	li(class="widget md:flex-col bg-(--LTheme4) dark:bg-(--Theme4)" tabindex="4")
		...
		div(v-if="false" class="w-full flex items-center py-2")
			lye-help-icon(:content="'Water is calculated as a percentage of total oils.'" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
		...
		div(class="relative w-full my-4 h-12 px-2 hover:border-blue-500 rounded-md flex justify-between items-center gap-2 border border-gray-500  text-black dark:text-white")
			lye-help-icon(:content="'Percentage of NaOH (lye) in the total lye solution.'" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
		...
		div(class="relative rounded-md flex items-center gap-2 px-2 hover:border-blue-500 h-13 w-full text-black dark:text-white border border-gray-500")
			lye-help-icon(:content="'A direct ratio of water to NaOH weight (e.g., 2:1, 2.5:1, 3:1).'" :strokeColor="'stroke-blue-500'" :darkStrokeColor="'stroke-blue-300'")
	...
	li(class="widget flex-col bg-(--LTheme4) dark:bg-(--Theme4)" tabindex="5")
		...
		div(class="w-full flex flex-nowrap md:flex-wrap gap-2 items-center justify-between")
			div(class="w-full flex items-center py-2")
				lye-help-icon(:content="'Water is calculated as a percentage of total oils.'" :strokeColor="'stroke-orange-400'" :darkStrokeColor="'stroke-orange-600'")
		...
		div(class="w-full flex flex-nowrap md:flex-wrap gap-2 items-center justify-between")
			div(class="w-full flex items-center py-2")
				lye-help-icon(:content="'Fragrance.'" :strokeColor="'stroke-fuchsia-400'" :darkStrokeColor="'stroke-fuchsia-600'")
